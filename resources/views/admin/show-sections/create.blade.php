<x-layouts::app :title="__('Create Section')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 p-4">
        <div class="flex items-center gap-2">
            ...
            <flux:heading size="xl">Create Section</flux:heading>
        </div>

        <form method="POST" action="{{ route('admin.show-sections.store') }}" class="max-w-lg space-y-4">
            @csrf
            ...
            <div class="flex gap-2">
                <flux:button type="submit" variant="primary">Create Section</flux:button>
