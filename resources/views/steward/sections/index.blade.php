                    ...
                    @foreach ($sections as $section)
                        <flux:table.row :key="$section->id">
                            <flux:table.cell variant="strong">
                                <a href="{{ route('steward.sections.show', $section) }}" class="hover:underline" wire:navigate>{{ $section->name }}</a>
                            </flux:table.cell>
                            <flux:table.cell>{{ $section->description ?? '—' }}</flux:table.cell>
                            <flux:table.cell>
                                <flux:button :href="route('steward.sections.show', $section)" size="sm" wire:navigate>Enter Results</flux:button>
                            </flux:table.cell>
                        </flux:table.row>
                    @endforeach
                </flux:table.rows>
